...
class EditorDecorator {
  ...
  getGutterItem(type, targetFilePath, targetPoint) {
    ...
    item.classList.add('runtime-info-atom-gutter-item', 'icon');
   ...
   */
  getGutter(type) {
    var gutterName = 'runtime-info-atom-' + type;
  ...
  decorateUnderLine(range) {
    ...
    this.textEditor.decorateMarker(marker, {
      type: 'text',
      class: 'runtime-info-atom-underline'
    });
  }
  /**
  ...
  decorateSuffix(range, text) {
    ...
    this.textEditor.decorateMarker(marker, {
      type: 'overlay',
      item: item,
      'class': 'runtime-info-atom-suffix',
      position: 'head',
      avoidOverflow: false
    });
  }
  ...
  getSuffixItem(text) {
    ...
    item.classList.add('runtime-info-atom-suffix-item');
